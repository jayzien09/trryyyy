...
void readLight(){
  ...
  //   lightScore = 4;
  // } else if (ambientLight >= 1000 && ambientLight < 2000){
  //   lightScore = 3;
  // } else if (ambientLight >= 2000 && ambientLight < 3000){
  //   lightScore = 2;
  // } else if (ambientLight >= 3000 && ambientLight < 4096){
  //   lightScore = 1;
  // }
  // Serial.print("Light Rating: ");
...
void loop() {
  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > timerDelay || sendDataPrevMillis == 0)){
    ...
    json.set(humPath.c_str(), String("1"));
