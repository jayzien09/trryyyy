...
import 'package:artemis_webapp/assessment/success%20page/govSuccess.dart';
...
class GovernanceAssess extends StatefulWidget {
  const GovernanceAssess({super.key});

  @override
  State<GovernanceAssess> createState() => _GovernanceAssessState();
}

class _GovernanceAssessState extends State<GovernanceAssess> {
  ...
  void updateScore() async {
    await AuthMethods().updateGovScore(
      govScore: govAssessScore,
      lastAssessDateGov: formattedDate,
      isAssessedGov: true,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '$questionNumber of ${questionsGov.length}',
                                style: AppTextStyles.tabs,
                              )
                            ],
                          ),
                          ...
                          StepProgressIndicator(
                            size: 5,
                            padding: 5,
                            totalSteps: questionsGov.length,
                          ...
                          Text(
                              'Assess the governance management of the company',
                              style: AppTextStyles.tabs),
                          SizedBox(
                            height: 80,
                          ),
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                "Category: ${questionsGov[index].category}",
                                              ...
                                              Text(questionsGov[index].question,
                                                  style:
                                        ...
                                        Container(
                                          width:
                                              MediaQuery.of(context).size.width,
                                          child: questionsGov[index].options,
                                        ),
                                      ],
                                    ),
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            onPressed: () {
                                              setState(() {
                                                govAssessScore =
                                                    govAssessScore + value;
                                                print(
                                                    "SUM GOV SCORE: $govAssessScore");
                                              });
                                              if (_controller.page?.toInt() ==
                                                  questionsGov.length - 1) {
                                                setState(() {
                                                  govAssessScore =
                                                      govAssessScore /
                                                          questionsGov.length;
