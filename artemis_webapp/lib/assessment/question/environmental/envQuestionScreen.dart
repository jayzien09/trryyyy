...
import 'package:artemis_webapp/assessment/success%20page/envSuccess.dart';
...
class EnvironmentalAssess extends StatefulWidget {
  const EnvironmentalAssess({super.key});

  @override
  State<EnvironmentalAssess> createState() => _EnvironmentalAssessState();
}

class _EnvironmentalAssessState extends State<EnvironmentalAssess> {
  ...
  void updateScore() async {
    await AuthMethods().updateEnvScore(
      envScore: envAssessScore,
      lastAssessDateEnv: formattedDate,
      isAssessedEnv: true,
  ...
  //date time subtract 1 month
  DateTime subtractOneMonth = DateTime.now().subtract(const Duration(days: 30));
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '$questionNumber of ${questionsEnv.length}',
                                style: AppTextStyles.tabs,
                              )
                            ],
                          ),
                          ...
                          StepProgressIndicator(
                            size: 5,
                            padding: 5,
                            totalSteps: questionsEnv.length,
                          ...
                          Text(
                              'Assess the environmental management of the company',
                              style: AppTextStyles.tabs),
                          SizedBox(
                            height: 80,
                          ),
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "Category: ${questionsEnv[index].category}",
                                          ...
                                          Text(questionsEnv[index].question,
                                    ...
                                    Container(
                                      width: MediaQuery.of(context).size.width,
                                      child: questionsEnv[index].options,
                                    ),
                                    SizedBox(
                                      height:
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                          onPressed: () {
                                            setState(() {
                                              envAssessScore =
                                                  envAssessScore + value;
                                              print(
                                                  "SUM ENV SCORE: $envAssessScore");
                                            });
                                            if (_controller.page?.toInt() ==
                                                questionsEnv.length - 1) {
                                              setState(() {
                                                envAssessScore =
                                                    envAssessScore /
                                                        questionsEnv.length;
