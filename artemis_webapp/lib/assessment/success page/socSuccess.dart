...
class SocialSuccess extends StatefulWidget {
  const SocialSuccess({super.key});

  @override
  State<SocialSuccess> createState() => _SocialSuccessState();
}

class _SocialSuccessState extends State<SocialSuccess> {
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                width: 800,
                                child: Text(
                                  'Please wait for the social results within 24 hours. ',
                                  style: AppTextStyles.tabs,
