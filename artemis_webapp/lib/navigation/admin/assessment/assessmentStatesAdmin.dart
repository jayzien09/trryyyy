...
class AssessmentAdminStateAdmin extends StatefulWidget {
  const AssessmentAdminStateAdmin({Key? key}) : super(key: key);

  @override
  _AssessmentAdminStateAdminState createState() =>
      _AssessmentAdminStateAdminState();
}

class _AssessmentAdminStateAdminState extends State<AssessmentAdminStateAdmin> {
  List<bool> selected = [false, true, false, false, false, false];
  void select(int n) {
    for (int i = 0; i < 6; i++) {
      if (i != n) {
        selected[i] = false;
