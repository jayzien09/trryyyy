...
import 'package:artemis_webapp/navigation/admin/socials/socialsStatesAdmin.dart';
import 'package:artemis_webapp/navigation/appLogo.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class SocialsAdmin extends StatelessWidget {
  const SocialsAdmin({Key? key}) : super(key: key);
