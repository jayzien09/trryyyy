...
import 'package:artemis_webapp/navigation/telemetry/navbarStatesTelemetry.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class NavBarTelemetry extends StatelessWidget {
  const NavBarTelemetry({Key? key}) : super(key: key);
