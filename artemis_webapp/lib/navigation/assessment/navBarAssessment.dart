...
import 'package:artemis_webapp/navigation/assessment/navBarStatesAssessment.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class NavBarAssessment extends StatelessWidget {
  const NavBarAssessment({Key? key}) : super(key: key);
