...
class NavBarStatesAssessment extends StatefulWidget {
  const NavBarStatesAssessment({Key? key}) : super(key: key);

  @override
  _NavBarStatesAssessmentState createState() => _NavBarStatesAssessmentState();
}

class _NavBarStatesAssessmentState extends State<NavBarStatesAssessment> {
