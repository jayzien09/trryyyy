...
class NavBarStateProfile extends StatefulWidget {
  const NavBarStateProfile({Key? key}) : super(key: key);

  @override
  _NavBarStateProfileState createState() => _NavBarStateProfileState();
}

class _NavBarStateProfileState extends State<NavBarStateProfile> {
  List<bool> selected = [false, false, false, false, true, false, false];
  void select(int n) {
    for (int i = 0; i < 7; i++) {
      if (i != n) {
        selected[i] = false;
