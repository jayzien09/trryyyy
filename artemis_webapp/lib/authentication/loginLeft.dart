...
class LoginScreenLeft extends StatefulWidget {
  const LoginScreenLeft({super.key});

  @override
  State<LoginScreenLeft> createState() => _LoginScreenLeftState();
}

class _LoginScreenLeftState extends State<LoginScreenLeft> {
  @override
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Image(image: AssetImage('assets/images/ESG.png')),
                    ),
                  ),
                ),
                Positioned(
